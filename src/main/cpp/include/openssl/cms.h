...
int CMS_set_detached(CMS_ContentInfo * cms, int
detached ) ;
...
CMS_ContentInfo *CMS_sign_receipt(CMS_SignerInfo * si,
                                  ...
                                  STACK_OF(X509) * certs, unsigned int
flags ) ;
...
flags ) ;
CMS_ContentInfo *CMS_data_create_ex(BIO * in, unsigned int
flags ,
OSSL_LIB_CTX *libctx,
const char *propq ) ;
...
const EVP_MD *md,
unsigned int flags ) ;
CMS_ContentInfo *CMS_digest_create_ex(BIO * in,
const EVP_MD *md,
unsigned int flags, OSSL_LIB_CTX * libctx ,
const char *propq ) ;
...
int CMS_verify(CMS_ContentInfo * cms, STACK_OF(X509) * certs,
               X509_STORE * store, BIO * dcont, BIO * out, unsigned int
flags ) ;

int CMS_verify_receipt(CMS_ContentInfo * rcms, CMS_ContentInfo * ocms,
                       STACK_OF(X509) * certs,
                       X509_STORE * store, unsigned int
flags ) ;
...
int CMS_decrypt(CMS_ContentInfo * cms, EVP_PKEY * pkey, X509 * cert,
                BIO * dcont, BIO * out, unsigned int
flags ) ;
...
int CMS_decrypt_set1_password(CMS_ContentInfo * cms,
                              unsigned char * pass, ossl_ssize_t
passlen ) ;
...
BIO *CMS_EnvelopedData_decrypt(CMS_EnvelopedData * env, BIO * detached_data,
                               ...
                               ASN1_OCTET_STRING * secret, unsigned int
flags ,
OSSL_LIB_CTX *libctx,
const char *propq ) ;

CMS_RecipientInfo *CMS_add1_recipient_cert(CMS_ContentInfo * cms,
                                           X509 * recip, unsigned int
flags ) ;
CMS_RecipientInfo *CMS_add1_recipient(CMS_ContentInfo * cms, X509 * recip,
                                      EVP_PKEY * originatorPrivKey, X509 * originator, unsigned int
flags ) ;
...
int CMS_uncompress(CMS_ContentInfo * cms, BIO * dcont, BIO * out,
                   unsigned int
flags ) ;
CMS_ContentInfo *CMS_compress(BIO * in, int
comp_nid , unsigned int flags ) ;
...
X509_ATTRIBUTE *CMS_signed_delete_attr(CMS_SignerInfo * si, int
loc ) ;
...
X509_ATTRIBUTE *CMS_unsigned_delete_attr(CMS_SignerInfo * si, int
loc ) ;
