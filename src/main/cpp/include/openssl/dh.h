...
OSSL_DEPRECATEDIN_3_0 int DH_set_method(DH * dh,
...
OSSL_DEPRECATEDIN_3_0 int DH_set_ex_data(DH * d, int
idx , void *arg ) ;
OSSL_DEPRECATEDIN_3_0 void *DH_get_ex_data(const DH *d, int idx);

OSSL_DEPRECATEDIN_3_0 int DH_generate_parameters_ex(DH * dh, int
prime_len ,
int generator,
        BN_GENCB * cb ) ;
...
OSSL_DEPRECATEDIN_3_0 int DH_meth_set_flags(DH_METHOD * dhm, int
flags ) ;
