...
int X509_ACERT_sign(X509_ACERT * x, EVP_PKEY * pkey,
const EVP_MD *md
);
...
X509_ATTRIBUTE *X509_ACERT_delete_attr(X509_ACERT * x, int
loc);

void *X509_ACERT_get_ext_d2i(const X509_ACERT *x, int nid, int *crit, int *idx);

int X509_ACERT_add1_ext_i2d(X509_ACERT * x, int
nid,
void *value,
int crit,
unsigned long flags
...
int X509_ACERT_set_version(X509_ACERT * x, long
version);
...
int X509_ACERT_add1_attr_by_OBJ(X509_ACERT * x,
const ASN1_OBJECT *obj,
int type,
const void *bytes,
int len
);
int X509_ACERT_add1_attr_by_NID(X509_ACERT * x, int
nid,
int type,
const void *bytes,
int len
);
int X509_ACERT_add1_attr_by_txt(X509_ACERT * x,
const char *attrname,
int type,
...
int X509_ACERT_set1_issuerName(X509_ACERT * x,
const X509_NAME *name
);
int X509_ACERT_set1_serialNumber(X509_ACERT * x,
const ASN1_INTEGER *serial
);
int X509_ACERT_set1_notBefore(X509_ACERT * x,
const ASN1_GENERALIZEDTIME *time
);
int X509_ACERT_set1_notAfter(X509_ACERT * x,
const ASN1_GENERALIZEDTIME *time
);
...
int OSSL_IETF_ATTR_SYNTAX_add1_value(OSSL_IETF_ATTR_SYNTAX * a, int
type,
void *data
);
...
typedef STACK_OF(OSSL_TARGET)
OSSL_TARGETS;
typedef STACK_OF(OSSL_TARGETS)
...
typedef STACK_OF(OSSL_ISSUER_SERIAL)
