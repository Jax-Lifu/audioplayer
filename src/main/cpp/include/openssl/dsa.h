...
OSSL_DEPRECATEDIN_3_0 int DSA_set_method(DSA * dsa,
const DSA_METHOD * ) ;
...
OSSL_DEPRECATEDIN_3_0 int DSA_set_ex_data(DSA * d, int
idx , void *arg ) ;
...
#  ifndef OPENSSL_NO_DEPRECATED_3_0
/* New version */
OSSL_DEPRECATEDIN_3_0 int DSA_generate_parameters_ex(DSA * dsa, int
bits ,
const unsigned char *seed,
int seed_len,
int *counter_ret,
...
OSSL_DEPRECATEDIN_3_0 void DSA_clear_flags(DSA * d, int
flags ) ;
OSSL_DEPRECATEDIN_3_0 int DSA_test_flags(const DSA *d, int flags);
OSSL_DEPRECATEDIN_3_0 void DSA_set_flags(DSA * d, int
flags ) ;
...
OSSL_DEPRECATEDIN_3_0 int DSA_meth_set_flags(DSA_METHOD * dsam, int
flags ) ;
