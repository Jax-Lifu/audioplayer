...
public:
    ...
    static void readTableSegmentData(CStrData &SD, int NrOfChannels, int FrameLen, int MaxNrOfSegs,
    ...
    static void readTableMappingData(CStrData &SD, int NrOfChannels, int MaxNrOfTables, CSegment &S,
    ...
    static void
    readFilterCoefSets(CStrData &SD, int NrOfChannels, CFrameHeader &FH, CCodedTableF &CF);

    static void readProbabilityTables(CStrData &SD, CFrameHeader &FH, CCodedTableP &CP,
